(function() {
  ...
  var saved =
  [ [[0, 0, 0, 0], [2, 2, 2, 2], [2, 2, 2, 2], [0, 2, 2, 0]]
  , [[0, 0, 0, 0], [2, 2, 2, 2], [2, 2, 2, 2], [0, 2, 2, 0]]
  , [[0, 0, 2, 0], [0, 2, 2, 2], [2, 2, 2, 0], [0, 2, 0, 0]]
  , [[0, 2, 2, 0], [2, 2, 0, 2], [2, 0, 2, 2], [0, 2, 2, 0]]
  , [[0, 2, 0, 0], [2, 2, 0, 0], [0, 0, 2, 2], [0, 0, 2, 0]]
  , [[0, 2, 2, 0], [2, 2, 2, 2], [0, 2, 2, 0], [0, 2, 2, 0]]
...
function load() {
  count = 0;
  holding = false;
  var k = document.getElementById('select').selectedIndex;
  for (var i = 0; i < size; i++)
    for (var j = 0; j < size; j++)
      state[i][j] = saved[k][i][j];
  update();
}
